...
public class Client extends JPanel {
    ...
    private final JButton bAdd = new JButton("Add new client");
    private final JButton bEdit = new JButton("Edit client");
    private final JButton bViewAll = new JButton("View all clients");
