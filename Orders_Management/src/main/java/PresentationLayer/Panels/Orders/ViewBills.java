...
public class ViewBills extends JPanel {
    ...
    private final JLabel title = new JLabel("View all bills");
    ...
    public ViewBills(){
        ...
        springLayout.putConstraint(SpringLayout.WEST, scrollPanel, 90, SpringLayout.WEST, this);
        springLayout.putConstraint(SpringLayout.EAST, scrollPanel, -90, SpringLayout.EAST, this);
    ...
    public void setBills(ArrayList<Bills> list){
            JTable table = new TabelGenerator<Bills>().setTable(list);
